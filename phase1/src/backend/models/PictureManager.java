...
public class PictureManager implements Observer {
	...
	/**
	 * Deletes a tag. It will update all the pictures in this instance that has
	 * this tag so that these pictures do not have the deleted tag anymore.
	 *
	 * @param tag
	 *            The tag to delete.
	 */
	...
	/**
	 * Adds a unique picture to this class. It will also add this as an observer
	 * to the new picture. If the picture already exist, it will not add it. To
	 * see if a picture exist, refer to the Picture.equals() to see if two
	 * pictures are equal
	 * 
	 * @param picture
	 *            A picture
	...
	/**
	 * Untracks a picture from this class and the picture no longer becomes
	 * observed from this class. If the picture does not exist, it will do
	 * nothing
	 * 
	 * @param picture
	 *            A picture in this class.
	 */
	...
	/**
	 * Determines whether a picture is in this instance or not. If it is in this
	 * instance, it is being tracked.
	 * 
	...
	/**
	 * This method is called whenever the observed object is changed. When the
	 * arguements and the observable object is a Picture object, and this
	 * instance is keeping track of this object, it will perform the changes of
	 * the Picture class in the IO level.
	 *
	 * @param o
