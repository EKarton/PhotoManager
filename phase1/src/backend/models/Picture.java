...
public class Picture extends Observable implements Serializable, Observer {
	...
	/**
	 * The directory path to the picture, i.e, it is the absolute path without
	 * the full file name.
	 */
	 ...
	 * 
	 * @param absolutePath
	 *            The absolute path to the Picture
	 */
	...
	/**
	 * Set the directory path of this picture It will notify all the observers
	 * that it has changed. It will send a copy of its old Picture instance to
	 * the observers
	 *
	 * @param directoryPath
	 *            The new directory path to this picture.
	 */
	...
	/**
	 * Set the tagless name of this picture. It will notify all the observers
	 * that it has changed. It will send a copy of its old Picture instance to
	 * the observers
	 *
	 * @param taglessName
	 *            The new tagless name of this picture.
	 */
	...
	/**
	 * If any change has happened to a Tag in this picture, the picture will
	...
	/**
	 * two Picture Object are considered equal if they have the same
	 * absolutePath
	 */
	@Override
