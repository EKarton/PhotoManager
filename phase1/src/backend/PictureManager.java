...
public class PictureManager implements Observer {
  ...
  /**
   * Creates a new instance of a PictureManager with an initial Picture/Tag mappings in a
   * BiDirectionalMap
   * 
  ...
  /**
   * Creates a new instance of a PictureManager that keep track. of the Picture-Tag mappings under a
   * directory path.
   * 
