...
public class PictureManager implements Observer {
    ...
    /**
     * Deletes a tag. It will update all the pictures in this instance
     * that has this tag so that these pictures do not have the deleted tag anymore.
    ...
    /**
     * Return a list of pictures stored in this class that has
     * a certain tag
     * @param tag A tag
     ...
     * When the arguements and the observable object is a Picture object, and this
     * instance is keeping track of this object, it will perform the changes of the
     * Picture class in the IO level.
